        ...
        <div className="h-screen overflow-hidden bg-gradient-to-br from-surface-50 via-[#069494]/10 to-[#069494]/5 flex">
            ...
            <div className="flex-1 flex flex-col justify-center px-5 py-5 lg:px-8 lg:py-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-md">
                    ...
                    {/* Header */}
                    <h1 className="text-[2rem] font-black text-surface-900 mb-1.5">{t('auth.createAccount')}</h1>
                    <p className="text-base text-surface-600 font-medium mb-5">{t('auth.startJourney')}</p>
                </div>
                ...
                <div className="sm:mx-auto sm:w-full sm:max-w-md">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3.5 mb-5">
                        ...
                        <div>
                            <label htmlFor="name" className="block text-sm font-bold text-surface-900 mb-1.5">
                                {t('auth.fullName')}
                            </label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label htmlFor="password" className="block text-sm font-bold text-surface-900 mb-1.5">
                                {t('auth.password')}
                            </label>
                            <input
                                type="password"
                    ...
                    <p className="text-center text-sm text-surface-700 font-medium">
                        {t('auth.haveAccount')}{' '}
                        <Link to="/login" className="font-bold text-[#069494] hover:text-[#035f5f] cursor-pointer transition-colors duration-150">
                            {t('auth.signIn')}
                        </Link>
                    </p>
            ...
            <div className="hidden lg:flex lg:flex-1 bg-gradient-to-br from-[#0b8b91] via-[#11a3a3] to-[#06666f] items-center justify-center p-10 relative overflow-hidden">
                ...
                <div className="relative max-w-md text-center z-10">
                    ...
                    <p className="text-white/85 leading-relaxed text-base font-medium">
                        Join thousands of students learning in a more natural, intuitive way.
                    </p>
                </div>
            </div>
        </div>
