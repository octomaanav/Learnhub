...
function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                <button
                  ...
                  className={`px-4 py-2 rounded-xl font-bold transition-colors hidden sm:flex items-center gap-2 ${isZenMode ? 'bg-[#069494] text-white hover:bg-[#057a7a]' : 'bg-[#069494]/10 text-[#069494] hover:bg-[#069494]/20'}`}
      ...
      {/* Zen Mode Overlay */}
      <div
        className={`fixed inset-0 bg-white/95 backdrop-blur-sm z-50 transition-all duration-1000 ease-in-out ${isZenMode ? 'opacity-100 pointer-events-auto delay-300' : 'opacity-0 pointer-events-none'}`}
      >
        <div className="h-full w-full flex flex-col items-center justify-center p-6">
          {isZenMode && (
            <div className="text-center w-full max-w-4xl px-4 flex flex-col items-center justify-center h-full">
              ...
              <div className="flex items-center justify-center gap-2 mb-4 h-16">
                ...
                {[1, 2, 3, 4, 5, 6, 7].map((i) => (
                  <div
                    key={i}
                    className="w-3 bg-gradient-to-t from-secondary-400 to-tertiary-500 rounded-full wave-bar shadow-lg shadow-secondary-400/30"
                    style={{
                      height: '100%',
              ...
              <h2 className="text-3xl font-black font-display text-surface-800 tracking-tight mb-2">
                I'm listening.
              </h2>
              <p className="text-base font-bold text-surface-500 max-w-xl text-center mb-6">
              ...
              <div className="w-full max-w-3xl flex-1 max-h-[50vh] bg-surface-100 rounded-2xl border-4 border-dashed border-surface-300 flex items-center justify-center relative overflow-hidden transition-all duration-500 group hover:border-secondary-300 backdrop-blur-sm shadow-2xl p-4">
                {visualState ? (
                  visualState.type === 'image_prompt' ? (
                    <img
                      ...
                      className="max-w-full max-h-full object-contain animate-fade-in mix-blend-multiply"
                    />
                  ) : (
                    <div className="p-4 text-left bg-white/90 w-full h-full overflow-auto text-sm text-surface-700 font-mono animate-fade-in shadow-inner rounded-xl">
              ...
              <button
                ...
                className="mt-6 px-6 py-3 bg-surface-200 hover:bg-surface-300 text-surface-700 font-bold rounded-xl transition-all"
              >
                Exit Zen Mode
              </button>
            </div>
